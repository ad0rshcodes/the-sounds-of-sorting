...
public class ControlPanel extends JPanel {
    ...
    public static final int[] bMinorPentatonicValues = new int[] { 46, 49, 51, 53, 56, 58, 61,
            63, 65, 68, 70, 73, 75, 78, 82, 85, 87 };
    ...
    public ControlPanel(NoteIndices notes, ArrayPanel panel) {
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Create a copy of the current notes array for generating events
                Integer[] notesCopy = notes.getNotes().clone();

                // Generate the sorting events
                List<SortEvent<Integer>> events = generateEvents(
                        (String) sorts.getSelectedItem(), notesCopy);

                // Add compare events at the end
                for (int i = 0; i < notesCopy.length - 1; i++) {
                    ...
                    public void run() {
                        if (index < events.size()) {
                            ...
                            for (int i : e.getAffectedIndices()) {
                                scale.playNote(notes.getNotes()[i], false);
                            }
